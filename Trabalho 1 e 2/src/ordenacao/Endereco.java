...
public class Endereco {
    ...
    //Uso do Comparator, comparando os ceps do arquivo
    static Comparator<Endereco> COMPARA_CEP = new Comparator<Endereco>() 
    {
       public int compare(Endereco antigo, Endereco novo) {
           return antigo.getCep().compareTo(novo.getCep());
       }
  };
